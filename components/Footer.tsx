...
const socialLinks = [
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M21.4466 9.37414C20.89 9.62038 20.2996 9.78211 19.6952 9.85398C20.332 9.47278 20.8085 8.87309 21.036 8.16664C20.4376 8.52215 19.7827 8.77237 19.0996 8.90642C18.5231 8.29134 17.7173 7.94277 16.8742 7.94373C15.1904 7.94373 13.8248 9.30892 13.8248 10.9935C13.8248 11.2324 13.8522 11.4642 13.9035 11.6878C11.3681 11.5602 9.12193 10.3468 7.61745 8.50159C7.34657 8.96699 7.20421 9.49601 7.20493 10.0345C7.20493 11.0925 7.74346 12.0263 8.56151 12.573C8.07725 12.5576 7.60367 12.4269 7.18024 12.1914C7.17977 12.2042 7.17977 12.217 7.17977 12.2291C7.17977 13.7071 8.23098 14.94 9.62645 15.2199C9.36455 15.2908 9.0944 15.3266 8.82308 15.3264C8.62602 15.3264 8.43479 15.3082 8.24891 15.2726C8.63721 16.4838 9.76271 17.3657 11.0976 17.3899C10.0174 18.2377 8.68342 18.6977 7.31021 18.6957C7.06717 18.6959 6.82434 18.6816 6.58301 18.6528C7.97712 19.549 9.59986 20.0247 11.2572 20.0229C16.8668 20.0229 19.934 15.3762 19.934 11.3466C19.934 11.2147 19.9308 11.0824 19.9249 10.952C20.5219 10.5207 21.0372 9.98636 21.4466 9.37414Z" fill="currentColor"/>
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M14.0016 6.70813C9.97455 6.70813 6.70996 9.97272 6.70996 13.9998C6.70996 17.6393 9.37642 20.6558 12.8623 21.2029V16.1075H11.0109V13.9998H12.8623V12.3934C12.8623 10.5659 13.9509 9.55644 15.6165 9.55644C16.4142 9.55644 17.2487 9.69885 17.2487 9.69885V11.4933H16.3292C15.4234 11.4933 15.141 12.0554 15.141 12.632V13.9998H17.1632L16.84 16.1075H15.141V21.2029C18.6268 20.6558 21.2933 17.6393 21.2933 13.9998C21.2933 9.97272 18.0287 6.70813 14.0016 6.70813Z" fill="currentColor"/>
      </svg>
    ),
  },
  {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(https://cdn.prod.website-files.com/6684af61b1cc1eae182f04b5/6684af61b1cc1eae182f04d1_CTA%20BG.png)',
      ...
      >
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-row items-center justify-center font-space-grotesk flex-wrap gap-4">
            <div className="text-2xl font-medium text-white">124 Trucks</div>
            <div className="bg-primary-50 w-1 h-1 mx-1 my-1 rounded-full"></div>
            <div className="text-2xl font-medium text-white">76 Ships</div>
            <div className="bg-primary-50 w-1 h-1 mx-1 my-1 rounded-full"></div>
            <div className="text-2xl font-medium text-white">22 Aeroplanes</div>
          </div>
        </div>
        <Link
          href="/pricing"
        ...
        >
          Apply Now &nbsp;<span className="text-neutral-500">~ &nbsp;Ebox Pro Logistics</span>
        </Link>
      </div>
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="text-sm leading-6 text-neutral-400">
              © 2024 Ebox Pro | Built by{" "}
              <a href="https://www.flowbase.co" target="_blank" className="text-primary hover:text-primary-hover">
                Flowbase
              </a>{" "}
              - Powered by{" "}
              <a href="https://www.webflow.com" target="_blank" className="text-primary hover:text-primary-hover">
                Webflow
              </a>
            </div>
            <div className="flex">
              <a href="/template/licence" className="text-neutral-400 hover:text-white text-sm transition-colors">
                License Information
              </a>
            </div>
          </div>
